...
import com.ava.arxivai.repository.AppUserRepository;
...
class AppUserResourceIT {
    ...
    public static AppUser createEntity(EntityManager em) {
        AppUser appUser = new AppUser().bio(DEFAULT_BIO).createdDate(DEFAULT_CREATED_DATE);
        return appUser;
    }
    ...
    public static AppUser createUpdatedEntity(EntityManager em) {
        AppUser appUser = new AppUser().bio(UPDATED_BIO).createdDate(UPDATED_CREATED_DATE);
        return appUser;
    }
    ...
    void putNewAppUser() throws Exception {
        ...
        updatedAppUser.bio(UPDATED_BIO).createdDate(UPDATED_CREATED_DATE);
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.bio(UPDATED_BIO).createdDate(UPDATED_CREATED_DATE);
