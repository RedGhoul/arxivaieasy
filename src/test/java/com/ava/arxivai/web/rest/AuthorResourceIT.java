...
class AuthorResourceIT {
    ...
    private static final String DEFAULT_HISTORY_LINK = "AAAAAAAAAA";
    private static final String UPDATED_HISTORY_LINK = "BBBBBBBBBB";
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).historyLink(DEFAULT_HISTORY_LINK);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).historyLink(UPDATED_HISTORY_LINK);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getHistoryLink()).isEqualTo(DEFAULT_HISTORY_LINK);
    }
    ...
    @Test
    @Transactional
    void checkHistoryLinkIsRequired() throws Exception {
        int databaseSizeBeforeTest = authorRepository.findAll().size();
        // set the field null
        author.setHistoryLink(null);
    ...
    void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.[*].historyLink").value(hasItem(DEFAULT_HISTORY_LINK)));
    }
    ...
    void getAuthor() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.historyLink").value(DEFAULT_HISTORY_LINK));
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).historyLink(UPDATED_HISTORY_LINK);
        ...
        assertThat(testAuthor.getHistoryLink()).isEqualTo(UPDATED_HISTORY_LINK);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.historyLink(UPDATED_HISTORY_LINK);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).historyLink(UPDATED_HISTORY_LINK);
