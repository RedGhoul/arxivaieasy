...
export class SubjectComponent implements OnInit {
  ...
  constructor(protected subjectService: SubjectService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.subjects = [];
    ...
    this.subjectService
      ...
      .subscribe(
        (res: HttpResponse<ISubject[]>) => {
          ...
          this.paginateSubjects(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
