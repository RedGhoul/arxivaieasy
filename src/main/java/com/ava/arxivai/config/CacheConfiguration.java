package com.ava.arxivai.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ava.arxivai.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ava.arxivai.repository.UserRepository.USERS_BY_EMAIL_CACHE);
